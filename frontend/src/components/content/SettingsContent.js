...
function SettingsContent({ isAdmin = false }) {
  ...
  const loadTransactions = async () => {
    try {
      const response = await fetch("http://localhost:8000/api/tokens/transactions/", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("access_token")}`,
        },
      });
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "10px" }}>
            ...
            <div style={{ 
              ...
              <p style={{ fontSize: "11px", color: "#6b7280", marginBottom: "3px", margin: 0 }}>Total Designs</p>
            ...
            <div style={{ 
              ...
              <p style={{ fontSize: "11px", color: "#6b7280", marginBottom: "3px", margin: 0 }}>Total Orders</p>
            ...
            <div style={{ 
              ...
              <p style={{ fontSize: "11px", color: "rgba(255, 255, 255, 0.9)", marginBottom: "3px", margin: 0 }}>Token Balance</p>
            ...
            <div style={{ 
              ...
              <p style={{ fontSize: "11px", color: "#6b7280", marginBottom: "3px", margin: 0 }}>Member Since</p>
        ...
        >
          ...
          {transactions.length === 0 ? (
            <div style={{ textAlign: "center", padding: "30px 15px", color: "#9ca3af" }}>
              ...
              <p style={{ fontSize: "12px", margin: 0 }}>No transactions yet</p>
            </div>
          ) : (
