...
function CartContent({ onTokenUpdate, onCheckout }) {
  ...
  const loadCart = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setMessage(`❌ ${data.error || "Failed to load cart"}`);
      }
    } catch (error) {
  ...
  const handlePlaceOrder = async () => {
    ...
    if (tokenBalance < totalCost) {
      setMessage("❌ Insufficient tokens. Please purchase more tokens.");
      return;
    }
    
    if (selectedFormats.length === 0) {
      setMessage("❌ Please select at least one file format.");
      return;
    }
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/cart/checkout/`, {
        ...
        body: JSON.stringify({ requested_formats: selectedFormats }),
      });
  ...
  return (
    <>
      <LoadingOverlay visible={loading || submitting} text={submitting ? "Processing order..." : "Loading cart..."} />
        ...
        {totalItems === 0 ? (
          ...
          >
            ...
            <p style={{ color: "#6b7280", marginBottom: "24px", fontSize: "14px" }}>
              Add designs to your cart to start placing orders
            </p>
            <button
              onClick={() => (window.location.href = "/new-design")}
              style={{
                padding: "12px 24px",
              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      {item.design_details?.name || "Untitled Design"}
                    </h3>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                      ...
                      >
                        {tokenCosts.order_placement} Tokens
                      </div>
                    </div>
                  </div>
            ...
            <div>
              ...
              >
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  >
                    <span style={{ color: "#6b7280" }}>Items ({totalItems})</span>
                ...
                <div style={{ marginBottom: "20px", padding: "16px", background: "#f9fafb", borderRadius: "8px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                    <h3 style={{ fontSize: "14px", fontWeight: "600", color: "#111827" }}>
                      Select Embroidery File Formats
                    </h3>
                    <button
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", minHeight: "36px", alignItems: "center" }}>
                    {selectedFormats.length > 0 ? (
                      ...
                      <p style={{ fontSize: "13px", color: "#6b7280", fontStyle: "italic" }}>
                        Click "Choose Formats" to select file formats
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ padding: "16px 20px", borderTop: "1px solid #e5e7eb", background: "#f9fafb" }}>
                        ...
                        >
                          Done ({selectedFormats.length} selected)
                        </button>
                      </div>
                    </div>
                  </div>
