...
class Design(models.Model):
    """Stores user designs with both normal and embroidery preview images"""
    STATUS_CHOICES = [
        ('draft', 'Draft'),
        ('ready', 'Ready'),
    ...
    text_style = models.CharField(max_length=50, default='Regular')
    text_size = models.IntegerField(default=36)  # Font size in pixels
    text_color = models.CharField(max_length=7, default='#000000')  # Hex color
    text_outline_color = models.CharField(max_length=7, default='#FFFFFF')  # Outline color
    text_outline_thickness = models.IntegerField(default=2)  # Thickness in pixels
    text_position_x = models.IntegerField(default=50)  # X position
    text_position_y = models.IntegerField(default=50)  # Y position
    
    # Thread Colors - FULL DETAILS
    thread_colors = models.JSONField(default=list, blank=True)  # List of complete color objects
    thread_brand = models.CharField(max_length=50, default='Madeira')
    thread_notes = models.TextField(blank=True, null=True)  # Customer notes about threads
    
    # Embroidery Settings - FULL DETAILS
    stitch_density = models.IntegerField(default=5)  # Scale 1-10
    stitch_type = models.CharField(max_length=50, default='Satin')  # Satin, Fill, Running, Bean
    auto_trim = models.BooleanField(default=True)
    underlay = models.BooleanField(default=True)  # Stabilization underlay
    jump_trim = models.BooleanField(default=True)  # Automatic jump trimming
    
    # Canvas/Design Settings
    canvas_width = models.IntegerField(default=1200)  # In pixels
    canvas_height = models.IntegerField(default=1200)  # In pixels
    design_width = models.IntegerField(default=100)  # In mm
    design_height = models.IntegerField(default=100)  # In mm
    hoop_size = models.CharField(max_length=50, default='100x100mm')
    rotation = models.IntegerField(default=0)  # In degrees
    mirror_horizontal = models.BooleanField(default=False)
